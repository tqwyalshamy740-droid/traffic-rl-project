...
from analysis.metrics import evaluate_dqn, print_metrics, REWARD_THRESHOLD
...
def main():
    ...
    metrics = evaluate_dqn(rewards, threshold=REWARD_THRESHOLD)
    ...
    logger.log_change(
        ...
        "Double DQN + reward normalization (scale=50) + pure negative reward (-avg_wait)",
